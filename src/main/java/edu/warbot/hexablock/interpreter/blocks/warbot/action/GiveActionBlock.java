 ...
 */
public class GiveActionBlock extends BlockAction {
     ...
     * @since 0.1
     */
    public GiveActionBlock(DoBlock father) {
        super(TypeBlock.GIVEACTIONBLOCK);
        setFather(father);
    ...
    public String getAction() {
        return ControllableActions.ACTION_GIVE;
    }
